...
package _language_reference__packages

// With this line, we've given the package at 'packages/' the name '_language_reference__packages':
// unnamed package at 'packages/' folder: [packages.odin] -> _language_reference__packages: [packages.odin]
...
// As a quick example of importing, the following line creates a public type alias called CustomString within this file, which belongs to the 'packages' package (known internally as '_language_reference__packages')
CustomString :: string
