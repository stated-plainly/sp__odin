...
// START - Display Tests
@(test)
NoteLetter_display_C :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_D :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_E :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_F :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_G :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_A :: proc(t: ^testing.T) {
...
@(test)
NoteLetter_display_B :: proc(t: ^testing.T) {
...
// START - Keyboard Friendly Tests
@(test)
NoteLetter_keyboard_friendly_C :: proc(t: ^testing.T) {
	c := music.NoteLetter.C;
...
@(test)
NoteLetter_keyboard_friendly_D :: proc(t: ^testing.T) {
	d := music.NoteLetter.D;
...
@(test)
NoteLetter_keyboard_friendly_E :: proc(t: ^testing.T) {
	e := music.NoteLetter.E;
...
@(test)
NoteLetter_keyboard_friendly_F :: proc(t: ^testing.T) {
	f := music.NoteLetter.F;
...
@(test)
NoteLetter_keyboard_friendly_G :: proc(t: ^testing.T) {
	g := music.NoteLetter.G;
...
@(test)
NoteLetter_keyboard_friendly_A :: proc(t: ^testing.T) {
	a := music.NoteLetter.A;
